...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/red010b37/navd/peer)
...
```bash
$ go get -u github.com/red010b37/navd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/red010b37/navd/peer#example-package--NewOutboundPeer)  
