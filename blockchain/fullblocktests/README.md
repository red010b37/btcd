...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/red010b37/navd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/red010b37/navd/blockchain/fullblocktests
```
